...
from datasets.lazy_pdbbind_load_receptor import LazyPDBBindSet_LoadReceptor
...
def get_dataset(args, model_args, confidence=False):
    dataset = LazyPDBBindSet_LoadReceptor(
                    transform=None, 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--plinder_dir', type=str, default='/vast/eac709/allo_crossdock/plinder/2024-06/v2/linked_structures_superpose/pred/', help='Folder containing plinder superposed structures')
    parser.add_argument('--pdbbind_dir', type=str, default='/vast/eac709/allo_crossdock/dataset_250623/', help='Folder containing original structures')
